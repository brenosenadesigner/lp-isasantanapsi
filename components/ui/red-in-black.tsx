...
// ("Flow field"). Zero dependencies: one WebGL canvas that fills its parent.
// Adaptado para a identidade visual Terracota & Dourado de Priscila Lopes.
...
// Paleta Terracota & Dourado Nobre
const UNIFORMS = {
  colors: [
    [0.18, 0.05, 0.04], // Sombra vinho / café terracota
    [0.48, 0.18, 0.17], // Terracota (#7A2E2B)
    [0.68, 0.28, 0.22], // Terracota quente (#AE4A38)
    [0.79, 0.58, 0.35], // Dourado Queimado (#C9935A)
    [0.88, 0.70, 0.51], // Dourado Claro (#DFB281)
    [0.88, 0.70, 0.51],
    [0.88, 0.70, 0.51],
    [0.88, 0.70, 0.51],
